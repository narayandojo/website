...
function AboutPage() {
  return (
    <div className="bg-white text-[#0f172a]">
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white text-center px-5 sm:px-6">

        <h1 className="text-3xl sm:text-4xl lg:text-3xl md:text-4xl lg:text-5xl font-bold mb-10">
          About NarayanDojo
        </h1>

        <div className="max-w-4xl mx-auto space-y-6 text-gray-300 leading-relaxed text-base md:text-lg">
      ...
      <section className="py-16 md:py-24 bg-gray-50 text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-5xl font-bold mb-16 text-[#001b63] drop-shadow-lg">
          MENTOR'S
        </h2>

        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10 px-6">

          {/* Mentor 1 */}
          <div className="bg-white p-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300">

            <img
              src="/mentor1.jpg"
              alt="mentor"
              className="w-24 h-24 md:w-32 md:h-32 rounded-full mx-auto mb-6 object-cover border-4 border-blue-100"
            />
          ...
          {/* Mentor 2 */}
          <div className="bg-white p-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300">
          ...
          <div className="bg-white p-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-300">
            ...
            <h3 className="font-bold text-xl md:text-2xl text-[#0f2a5f]">
              UDAY TADE
            </h3>
      ...
      <section className="py-16 md:py-24 bg-white text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-6">
          ...
          {/* SCIENCE */}
          <div className="relative h-[340px] sm:h-[400px] md:h-[500px] overflow-hidden rounded-xl shadow-xl group">
      ...
      <section className="py-24 bg-[#f3f3f3] text-center">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-5xl md:text-6xl font-bold mb-16 text-[#001b63] tracking-[8px] drop-shadow-lg">
          WHY NARAYANDOJO?
        </h2>

        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-6 md:p-8 px-6">
          ...
          ></div>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white animate-show">
              ...
              <h3 className="text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-5xl font-bold">
                INGENUITY
              </h3>
          ...
          <div className="relative h-[380px] overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white animate-show">
              ...
              <h3 className="text-3xl md:text-4xl lg:text-3xl md:text-4xl lg:text-3xl md:text-4xl lg: font-bold">
                CREATIVITY
              </h3>
